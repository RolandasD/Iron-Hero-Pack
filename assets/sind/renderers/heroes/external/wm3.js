...
function create(renderer, texture, lights, fire, beam) {
    var gun = renderer.createResource("MODEL", "sind:wm3gun");
    gun.bindAnimation("sind:wm3").setData((entity, data) => {
    ...
    var firemodel1 = renderer.createResource("MODEL", "sind:wm3gun_fire1");
    firemodel1.bindAnimation("sind:wm3").setData((entity, data) => {
        data.load(0, 1);
        data.load(1, entity.getInterpolatedData("fiskheroes:flight_boost_timer"));
    });
    ...
    var firemodel2 = renderer.createResource("MODEL", "sind:wm3gun_fire2");
    firemodel2.bindAnimation("sind:wm3").setData((entity, data) => {
        data.load(0, 1);
        data.load(1, entity.getInterpolatedData("fiskheroes:flight_boost_timer"));
    });
    ...
    var firemodel3 = renderer.createResource("MODEL", "sind:wm3gun_fire3");
    firemodel3.bindAnimation("sind:wm3").setData((entity, data) => {
        data.load(0, 1);
        data.load(1, entity.getInterpolatedData("fiskheroes:flight_boost_timer"));
    });
    ...
    var firemodel4 = renderer.createResource("MODEL", "sind:wm3gun_fire4");
    firemodel4.bindAnimation("sind:wm3").setData((entity, data) => {
        data.load(0, 1);
        data.load(1, entity.getInterpolatedData("fiskheroes:flight_boost_timer"));
    });
    firemodel4.texture.set(null, fire);
    var fire4 = renderer.createEffect("fiskheroes:model").setModel(firemodel4);
    fire4.anchor.set("body");

    var beammodel1 = renderer.createResource("MODEL", "sind:wm3beam1");
    beammodel1.bindAnimation("sind:wm3").setData((entity, data) => {
        data.load(0, 1);
        data.load(1, entity.getInterpolatedData("fiskheroes:flight_boost_timer"));
    });
    ...
    var beammodel2 = renderer.createResource("MODEL", "sind:wm3beam2");
    beammodel2.bindAnimation("sind:wm3").setData((entity, data) => {
        data.load(0, 1);
        data.load(1, entity.getInterpolatedData("fiskheroes:flight_boost_timer"));
    });
    ...
    var beammodel3 = renderer.createResource("MODEL", "sind:wm3beam3");
    beammodel3.bindAnimation("sind:wm3").setData((entity, data) => {
        data.load(0, 1);
        data.load(1, entity.getInterpolatedData("fiskheroes:flight_boost_timer"));
    });
    ...
    var beammodel4 = renderer.createResource("MODEL", "sind:wm3beam4");
    beammodel4.bindAnimation("sind:wm3").setData((entity, data) => {
        data.load(0, 1);
        data.load(1, entity.getInterpolatedData("fiskheroes:flight_boost_timer"));
    });
    beammodel4.texture.set(null, beam);
    var beam4 = renderer.createEffect("fiskheroes:model").setModel(beammodel4);
    ...
    gunbullet1.anchor.set("body", beammodel1.getCubeOffset("shoulder_pivot"));
    ...
    gunbullet2.anchor.set("body", beammodel2.getCubeOffset("shoulder_pivot"));
    ...
    gunbullet3.anchor.set("body", beammodel3.getCubeOffset("shoulder_pivot"));
    gunbullet3.setOffset(0.0, 0.0, 0.0).setRotation(0.0, 0.0, 0.0).setScale(8.0);
    gunbullet3.opacity = 0.30;

    gunbullet4 = utils.createLines(renderer, magazine, 0xfffff, [
        { "start": [0.0, 0.0, 0.0], "end": [0.0, 0.0, -40.0], "size": [3.25, 3.25] }
    ]);
    gunbullet4.anchor.set("body", beammodel4.getCubeOffset("shoulder_pivot"));
    gunbullet4.setOffset(0.0, 0.0, 0.0).setRotation(0.0, 0.0, 0.0).setScale(8.0);
    gunbullet4.opacity = 0.30;
        ...
        render: (entity) => {
            ...
            if (entity.getData("sind:dyn/wmgun_bool") && entity.getData("sind:dyn/wmgun_timer") >= 1) {
                if (entity.loop(10) < 0.25) {
                    ...
                    fire4.render();
                    beam4.render();
                    gunbullet4.progress = entity.getInterpolatedData("fiskheroes:energy_projection_timer");
                }
            }
        }
    };
