        ...
        render: (entity, renderLayer, isFirstPersonArm, all) => {
            if (!isFirstPersonArm) {
                if (all || renderLayer == "CHESTPLATE") {
                    ...
                    handR.progress = fR && entity.getData("sind:dyn/modularint2");
                    handL.progress = fL && entity.getData("sind:dyn/modularint2");
                ...
                if (all || renderLayer == "BOOTS") {
                    var boost = entity.getInterpolatedData("fiskheroes:flight_boost_timer");
                    boots.progress = entity.getInterpolatedData("fiskheroes:dyn/booster_timer") && entity.getData("sind:dyn/modularint4");;
