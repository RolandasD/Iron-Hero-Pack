        ...
        render: (entity, renderLayer, isFirstPersonArm, all) => {
            if (!isFirstPersonArm) {
                if (all || renderLayer == "CHESTPLATE") {
                    ...
                    handR.setRotation(-15, 0, -7 * flight - 10 * boost);
                    handL.setRotation(-15, 0, 7 * flight + 10 * boost);
                    handR.render();
                    handL.render();
