...
function init(hero) {
    hero.setName("Iron Man/\u00A74\u00A7lMark \u00A77\u00A7l48 \u00A76\u00A7l(XLVIII) \u00A7f\u00A7l- \u00A77\u00A7lHulkbuster Mk II");
    hero.setTier(8);

    hero.setChestplate("Hulkbuster Armor");

    hero.addPowers("sind:mk48", "sind:adv", "sind:hulkbuster", "sind:stark");
    ...
    hero.addAttribute("BASE_SPEED", 0.025, 0);
    ...
    hero.setTickHandler((entity, manager) => {
        ...
        if (!entity.is("DISPLAY") && entity.is("PLAYER")) {
            ...
            jarvis.health(entity, manager, "stark_hulkbuster");
            jarvis.lowhealth(entity, manager, "stark_hulkbuster");
            jarvis.mobscanner(entity, manager, "stark_hulkbuster");
            jarvis.heatwarning(entity, manager, "stark_hulkbuster");
            ...
            if(!entity.getData("sind:dyn/hulkbuster") || entity.getData("sind:dyn/hulkbuster_timer") == 0){
                if (entity.getData("sind:dyn/jarvis") && PackLoader.getSide() == "SERVER"){
                    entity.as("PLAYER").addChatMessage("\u00A76STARK O.S>\u00A7e STARK O.S Offline.");
                }
...
function isKeyBindEnabled(entity, keyBind) {
    ...
    switch (keyBind) {
        ...
        case "ENERGY_PROJECTION":
            return entity.getData("sind:dyn/fake_punch_timer") == 0 && entity.getData("fiskheroes:aiming_timer") == 1 && hbtimer == 1;    
        case "TRANSFORM":
            return !entity.isSneaking() && !transforming;
        case "EARTHQUAKE":
            return !beamcharging && !entity.getData("sind:dyn/ground_smash") && !aiming && (entity.getPunchTimer() == 0 || entity.getData("sind:dyn/earthquake")) && entity.getData("sind:dyn/earthquake_cooldown") == 0 && entity.isOnGround() && !entity.isSneaking() && hbtimer == 1 && !entity.getData("fiskheroes:moving");
        case "EARTH":
            return !beamcharging && !entity.getData("sind:dyn/ground_smash") && !aiming && !entity.isSneaking() && hbtimer == 1 && !entity.getData("fiskheroes:moving") && entity.isOnGround();
        case "GROUND_SMASH":
            return !beamcharging && !entity.getData("sind:dyn/earthquake") && !aiming && canAim(entity) && (entity.getPunchTimer() == 0 || entity.getData("sind:dyn/ground_smash")) && entity.getData("sind:dyn/ground_smash_cooldown") == 0 && entity.isOnGround() && hbtimer == 1;
        case "DISABLE_PUNCH":
        ...
        case "GROUND_SMASH_VISUAL":
            return !beamcharging && !entity.getData("sind:dyn/earthquake") && !aiming && canAim(entity) && hbtimer == 1;
        default:
            return true;
    }
}
