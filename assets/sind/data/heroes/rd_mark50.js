...
function init(hero) {
    hero.setName("RD Mark 50 / Mark VII Epsilon");

    hero.addPowers("sind:7aw_visual", "sind:mk7", "sind:jarvis", "sind:prototype");
    //tier, sentry, is advanced, type of rocket, can use arm laser, leftclick weapon type, isfriday, tony system
    iron_man.init(hero, 7, true, false, "SHOULDER", true, false, false, false);
