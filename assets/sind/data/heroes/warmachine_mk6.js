...
function init(hero) {
    hero.setName("War Machine/\u00A78\u00A7lMark 06 (VI)");

    hero.addPowers("sind:warmachine_mk6", "sind:stark");
    //tier, sentry, is advanced, type of rocket, can use arm laser, leftclick weapon type, isfriday, tony system
    iron_man.init(hero, 8, true, true, null, false, false, false, true);
    ...
    hero.addKeyBind("QUANTUM", "Toggle Quantum Suit", 3);
    hero.addKeyBind("QUANTUM_TP", "Travel to Quantum Realm", 3);
    hero.addKeyBind("QUANTUMQUANTUM_TP", "Return from Quantum Realm", 3);
