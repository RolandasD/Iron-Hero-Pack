...
function init(hero) {
    hero.setName("RD Mark 2 / Refined Frame");
    hero.setTier(4);
    ...
    hero.addAttribute("JUMP_HEIGHT", -0.43, 1);
    hero.addAttribute("BASE_SPEED", -0.33, 1);
    ...
    hero.setTickHandler((entity, manager) => {
        if (!entity.is("DISPLAY") && entity.is("PLAYER")) {
            ...
            if (entity.getData("sind:dyn/reloading")) {
                manager.setData(entity, "sind:dyn/fuel", timer - 0.023);
            }
