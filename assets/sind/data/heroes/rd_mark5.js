...
function init(hero) {
    hero.setName("RD Mark 5 / Pre-Ignition");
    hero.setTier(5);
    ...
    hero.addAttribute("FALL_RESISTANCE", 17.0, 0);
    hero.addAttribute("JUMP_HEIGHT", -0.29, 1);
    hero.addAttribute("BASE_SPEED", -0.22, 1);
    ...
    hero.setTickHandler((entity, manager) => {
        if (!entity.is("DISPLAY") && entity.is("PLAYER")) {
            ...
            if (entity.getData("sind:dyn/reloading")) {
                manager.setData(entity, "sind:dyn/fuel", timer - 0.017);
            }
