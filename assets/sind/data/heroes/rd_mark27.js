...
function init(hero) {
    hero.setName("RD Mark 27 / Mark XL Alpha");

    hero.addPowers("sind:mk40", "sind:7aw_visual", "sind:afflight", "sind:jarvis", "sind:prototype");
    ...
    hero.addAttribute("PUNCH_DAMAGE", 6.8, 0);
