...
function init(hero) {
    hero.setName("RD Mark 10 / Mark III Beta");

    hero.addPowers("sind:mk3", "sind:standard", "sind:jarvis", "sind:prototype");
    //tier, sentry, is advanced, type of rocket, can use arm laser, leftclick weapon type, isfriday, tony system
    iron_man.init(hero, 6, false, false, "SHOULDER", false, false, false, false);
    hero.addAttribute("PUNCH_DAMAGE", 5.8, 0);
